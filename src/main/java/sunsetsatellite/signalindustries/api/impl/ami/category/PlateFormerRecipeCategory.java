...
public class PlateFormerRecipeCategory implements RecipeCategory {
    ...
    public PlateFormerRecipeCategory() {
        ...
        localizedName = TranslationStorage.getInstance().get("container.signalindustries.plateFormer.name");
    ...
    public @NotNull String getUid() {
        return "signalindustries:recipe/plate_former";
    }
