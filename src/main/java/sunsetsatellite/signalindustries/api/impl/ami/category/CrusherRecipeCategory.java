...
public class CrusherRecipeCategory implements RecipeCategory {
    ...
    public CrusherRecipeCategory() {
        ...
        localizedName = TranslationStorage.getInstance().get("container.signalindustries.crusher.name");
    ...
    public @NotNull String getUid() {
        return "signalindustries:recipe/crusher";
    }
