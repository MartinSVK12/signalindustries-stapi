...
public class CrystalCutterRecipeCategory implements RecipeCategory {
    ...
    public CrystalCutterRecipeCategory() {
        ...
        localizedName = TranslationStorage.getInstance().get("container.signalindustries.crystalCutter.name");
    ...
    public @NotNull String getUid() {
        return "signalindustries:recipe/crystal_cutter";
    }
