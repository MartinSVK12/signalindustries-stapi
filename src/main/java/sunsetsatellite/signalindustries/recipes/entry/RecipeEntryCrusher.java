...
public class RecipeEntryCrusher extends RecipeEntryMachine {

    public RecipeEntryCrusher(RecipeSymbol[] input, ItemStack output, RecipeProperties data) {
        super(input, output, data);
    }

    public RecipeEntryCrusher() {
    }
}
