...
public class RecipeEntryCrystalCutter extends RecipeEntryMachine {
    public RecipeEntryCrystalCutter(RecipeSymbol[] input, ItemStack output, RecipeProperties data) {
        super(input, output, data);
    }

    public RecipeEntryCrystalCutter() {
    }
}
