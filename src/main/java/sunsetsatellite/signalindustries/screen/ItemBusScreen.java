...
public class ItemBusScreen extends HandledScreen {

    public ItemBusBlockEntity tile;

    public ItemBusScreen(PlayerInventory playerInventory, FluidItemContainerBlockEntity blockEntity) {
        super(new ItemBusScreenHandler(playerInventory, blockEntity));
        this.tile = (ItemBusBlockEntity) blockEntity;
    }
    ...
    protected void drawBackground(float tickDelta) {
        int bg = switch (tile.getTier()){
            case BASIC -> this.minecraft.textureManager.getTextureId("/assets/signalindustries/stationapi/textures/gui/basic_item_hatch.png");
            case REINFORCED -> this.minecraft.textureManager.getTextureId("/assets/signalindustries/stationapi/textures/gui/reinforced_item_hatch.png");
            default -> this.minecraft.textureManager.getTextureId("/assets/signalindustries/stationapi/textures/gui/basic_item_hatch.png");
        };
