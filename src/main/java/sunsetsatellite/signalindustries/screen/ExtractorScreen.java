...
public class ExtractorScreen extends HandledScreen {

    public ExtractorBlockEntity tile;

    public ExtractorScreen(PlayerInventory playerInventory, FluidItemContainerBlockEntity blockEntity) {
        super(new ExtractorScreenHandler(playerInventory, blockEntity));
        this.tile = (ExtractorBlockEntity) blockEntity;
    }
    ...
    protected void drawBackground(float tickDelta) {
        int bg = switch (tile.getTier()){
            case BASIC -> this.minecraft.textureManager.getTextureId("/assets/signalindustries/stationapi/textures/gui/extractor_basic.png");
            default -> this.minecraft.textureManager.getTextureId("/assets/signalindustries/stationapi/textures/gui/extractor_prototype.png");
        };
        ...
        if(tile.isActive()){
            ...
            drawTexture(x + 57, y + 36 + 12 - counter, 176, 12 - counter, 14, counter + 2);
        }
