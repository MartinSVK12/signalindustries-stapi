...
public class PlateFormerScreen extends HandledScreen {

    public PlateFormerBlockEntity tile;

    public PlateFormerScreen(PlayerInventory playerInventory, FluidItemContainerBlockEntity blockEntity) {
        super(new PlateFormerScreenHandler(playerInventory, blockEntity));
        this.tile = (PlateFormerBlockEntity) blockEntity;
    }
