...
public class PlateFormerScreenHandler extends MachineScreenHandler {
    public PlateFormerScreenHandler(PlayerInventory inv, FluidItemContainerBlockEntity tile) {
        super(inv, tile);
