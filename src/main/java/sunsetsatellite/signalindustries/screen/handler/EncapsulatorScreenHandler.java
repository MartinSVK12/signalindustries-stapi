...
public class EncapsulatorScreenHandler extends MachineScreenHandler {
    public EncapsulatorScreenHandler(PlayerInventory inv, FluidItemContainerBlockEntity tile) {
        super(inv, tile);

        FluidSlot slot = new FluidSlot(tile, 0, 8, 35);
        addFluidSlot(slot);
