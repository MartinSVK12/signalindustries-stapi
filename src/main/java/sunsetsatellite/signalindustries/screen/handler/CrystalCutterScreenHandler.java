...
public class CrystalCutterScreenHandler extends MachineScreenHandler {
    public CrystalCutterScreenHandler(PlayerInventory inv, FluidItemContainerBlockEntity tile) {
        super(inv, tile);
        ...
        this.addFluidSlot(new FluidSlot(tile, 1, 28, 17));
