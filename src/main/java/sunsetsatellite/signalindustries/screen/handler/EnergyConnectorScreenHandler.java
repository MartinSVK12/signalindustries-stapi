...
public class EnergyConnectorScreenHandler extends MachineScreenHandler {
    public EnergyConnectorScreenHandler(PlayerInventory inv, FluidItemContainerBlockEntity tile) {
        super(inv, tile);
