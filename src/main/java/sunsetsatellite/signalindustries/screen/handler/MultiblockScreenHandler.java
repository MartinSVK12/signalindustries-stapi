...
public class MultiblockScreenHandler extends MachineScreenHandler {
    public MultiblockScreenHandler(PlayerInventory inv, FluidItemContainerBlockEntity tile) {
        super(inv, tile);
