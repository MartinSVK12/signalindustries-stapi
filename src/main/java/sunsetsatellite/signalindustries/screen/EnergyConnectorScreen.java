...
public class EnergyConnectorScreen extends HandledScreen {

    public EnergyConnectorBlockEntity tile;

    public EnergyConnectorScreen(PlayerInventory playerInventory, FluidItemContainerBlockEntity blockEntity) {
        super(new EnergyConnectorScreenHandler(playerInventory, blockEntity));
        this.tile = (EnergyConnectorBlockEntity) blockEntity;
    }
    ...
    protected void drawBackground(float tickDelta) {
        int bg = switch (tile.getTier()){
            case BASIC -> this.minecraft.textureManager.getTextureId("/assets/signalindustries/stationapi/textures/gui/basic_energy_connector.png");
            case REINFORCED -> this.minecraft.textureManager.getTextureId("/assets/signalindustries/stationapi/textures/gui/reinforced_energy_connector.png");
            case AWAKENED -> this.minecraft.textureManager.getTextureId("/assets/signalindustries/stationapi/textures/gui/awakened_energy_connector.png");
