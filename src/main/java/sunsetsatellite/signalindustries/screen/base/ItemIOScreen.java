...
public class ItemIOScreen extends Screen {
    ...
    protected void buttonClicked(ButtonWidget button) {
        if(tile != null){
            ...
            if(button.id >= 0 && button.id <= 5){
                ...
                button.text = tile.itemConnections.get(dir).getLetter();
            ...
            if(button.id > 5 && button.id < 12){
                ...
                button.text = String.valueOf(tile.activeItemSlots.get(dir));
                currentButtonId = button.id;
            }
            ...
            if(button.id == 12) {
                ...
                for (Object o : buttons) {
                    ...
                    if(b.id >= 0 && b.id < 6){
                        b.text = tile.itemConnections.get(Direction.values()[b.id]).getLetter();
                    }
                }
                currentButtonId = button.id;
            }
            ...
            if (button.id == 14) {
                if (tile instanceof HasIOPreview p) {
                    p.setPreview(p.getPreview() != IOPreview.ITEM ? IOPreview.ITEM : IOPreview.NONE);
                }
            }
    ...
    protected void buttonClickedAlt(ButtonWidget button) {
        if(button.id > 5 && button.id < 12){
            ...
            button.text = tile.activeItemSlots.get(dir) == -1 ? "*" : String.valueOf(tile.activeItemSlots.get(dir));
    ...
    @Override
    public void init() {
        buttons.add(new ButtonWidget(2, Math.round(width / 2f) - 10, Math.round(height / 2f) - 63, 15, 15, tile.itemConnections.get(Direction.Y_POS).getLetter())); //Y+
        buttons.add(new ButtonWidget(4, Math.round(width / 2f) - 10, Math.round(height / 2f) - 48, 15, 15, tile.itemConnections.get(Direction.Z_POS).getLetter())); //Z+
        buttons.add(new ButtonWidget(3, Math.round(width / 2f) - 10, Math.round(height / 2f) - 33, 15, 15, tile.itemConnections.get(Direction.Y_NEG).getLetter())); //Y-
        buttons.add(new ButtonWidget(0, Math.round(width / 2f) + 4, Math.round(height / 2f) - 48, 15, 15, tile.itemConnections.get(Direction.X_POS).getLetter())); //X+
        buttons.add(new ButtonWidget(1, Math.round(width / 2f) - 24, Math.round(height / 2f) - 48, 15, 15, tile.itemConnections.get(Direction.X_NEG).getLetter())); //X-
        buttons.add(new ButtonWidget(5, Math.round(width / 2f) + 4, Math.round(height / 2f) - 33, 15, 15, tile.itemConnections.get(Direction.Z_NEG).getLetter())); //Z-

        buttons.add(new ButtonWidget(8, Math.round(width / 2f) - 10 + 50, Math.round(height / 2f) - 63, 15, 15, tile.activeItemSlots.get(Direction.Y_POS) == -1 ? "*" : String.valueOf(tile.activeItemSlots.get(Direction.Y_POS))));
        buttons.add(new ButtonWidget(10, Math.round(width / 2f) - 10 + 50, Math.round(height / 2f) - 48, 15, 15, tile.activeItemSlots.get(Direction.Z_POS) == -1 ? "*" : String.valueOf(tile.activeItemSlots.get(Direction.Z_POS))));
        buttons.add(new ButtonWidget(9, Math.round(width / 2f) - 10 + 50, Math.round(height / 2f) - 33, 15, 15, tile.activeItemSlots.get(Direction.Y_NEG) == -1 ? "*" : String.valueOf(tile.activeItemSlots.get(Direction.Y_NEG))));
        buttons.add(new ButtonWidget(6, Math.round(width / 2f) + 4 + 50, Math.round(height / 2f) - 48, 15, 15, tile.activeItemSlots.get(Direction.X_POS) == -1 ? "*" : String.valueOf(tile.activeItemSlots.get(Direction.X_POS))));
        buttons.add(new ButtonWidget(7, Math.round(width / 2f) - 24 + 50, Math.round(height / 2f) - 48, 15, 15, tile.activeItemSlots.get(Direction.X_NEG) == -1 ? "*" : String.valueOf(tile.activeItemSlots.get(Direction.X_NEG))));
        buttons.add(new ButtonWidget(11, Math.round(width / 2f) + 4 + 50, Math.round(height / 2f) - 33, 15, 15, tile.activeItemSlots.get(Direction.Z_NEG) == -1 ? "*" : String.valueOf(tile.activeItemSlots.get(Direction.Z_NEG))));
