...
public class VisualFluidIOScreen extends Screen {
    ...
    public VisualFluidIOScreen(PlayerEntity player, ScreenHandler handler, Screen parent, FluidItemContainerBlockEntity tile) {
        super();
        this.player = player;
        this.tile = tile;
    ...
    public void renderBlock(int mx, int my) {
        ...
        TieredMachineBlock.ioType = IOPreview.FLUID;
    ...
    protected void buttonClicked(ButtonWidget button) {
        if(tile != null){
            ...
            if (button.id == 3) {
                for (Direction direction : Direction.values()) {
                    tile.fluidConnections.replace(direction, Connection.NONE);
                }
                currentButtonId = button.id;
            }
